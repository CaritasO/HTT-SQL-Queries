...
--Question 1. Calculate the average revenue generated per month? (Reviewed Question)
...
--and revenue distribution across different paper types and total revenue?
...
--Question 8. What is the yearly trend in revenue growth (or decline) over time, (Reviewed Question)
--by paper type?
...
FROM orders
JOIN web_events ON orders.account_id = web_events.account_id
